...
const Animation = () => {
    ...
    return (
        <div className='mt-20 min-h-[300px]'>
            ...
            <div className='h-[300px] mt-20 w-full flex'>
            <div className='h-50 ml-[10%] w-1/2 inline' data-aos="flip-right"><span><img className='h-64' src='https://d2hw29brqn7o70.cloudfront.net/media/catalog/product/cache/1/image/720x/9df78eab33525d08d6e5fb8d27136e95/o/d/odysseybattery-hk-pc1200.jpg'></img></span></div>
            <div  className='h-50 w-1/2 inline object-cover' data-aos="fade-up-left">
                <img src='https://cdn.xxl.thumbs.canstockphoto.com/wooden-baby-kit-for-mathematics-close-up-stock-photo_csp4750594.jpg'/>
            </div>
            </div>
