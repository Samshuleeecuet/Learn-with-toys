...
const Footer = () => {
  ...
  <div>
    ...
    <a className="link link-hover">Phone: 018166244741</a> 
    <a className="link link-hover">Email: samshul2001@gmail.com</a> 
    <a className="link link-hover">Address: Chittagong University of Engineering and Technology(CUET)</a>
  </div>
</footer> 
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    <img className='h-12 rounded-full pr-2' src={logo} />
    <p className='text-lg font-bold'>Learn With Toys</p>
  </div>
  <div>
  <p className='font-semibold'>Copyright © 2023 - All right reserved by Learn With Toys</p>
    </div> 
</footer>
        </div>
    );
